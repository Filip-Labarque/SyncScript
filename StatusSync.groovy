...
class StatusSync {
    ...
    static com.exalate.basic.domain.hubobject.v1.BasicHubIssue receive(Closure<BasicHubIssue> onNoStatusFoundFn,
        ...
        try {
            ...
            transitionTo(onNoStatusFoundFn, desiredStatusName, projectWorkflowSchemeMapping, workflowSchemeMapping, workflowDetailsMapping, replica, issue, nodeHelper, httpClient, false)
